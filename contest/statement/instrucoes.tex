...
A prova pode conter problemas interaivos. Nesse tipo de problema, os dados de entrada fornecidos ao seu programa podem não ser predeterminados, mas são construídos especificamente para a sua solução. O juiz escreve um programa especial (o interador), cuja saída é transferida para a entrada da sua solução, e a saída do seu programa é enviada para a entrada do interador. Em outras palavras, sua solução e o interador trocam dados e podem decidir o que imprimir com base no histórico da comunicação.
