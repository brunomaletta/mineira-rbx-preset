...
O sistema de correção de submissões será executado na distribuição \texttt{Ubuntu GNU/Linux 22.04 LTS amd64}, com os seguintes ccinfigurações.
...
\begin{itemize}
	...
	\item Programs em Python passarão por verificação de sintaxe; erros resultarão em ``\texttt{Compilation Error}''.
